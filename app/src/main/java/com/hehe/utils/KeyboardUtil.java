...
public class KeyboardUtil {
    ...
    private KeyboardUtil(Activity activity, EditText edit) {
        this.ed = edit;
        k1 = new Keyboard(activity, R.xml.symbols);
        k2 = new Keyboard(activity, R.xml.symbols);
        k3 = new Keyboard(activity, R.xml.symbols);
        ...
        rootView = (ViewGroup) ((ViewGroup) activity.findViewById(R.id.container));
